  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="flex flex-wrap items-end gap-3 mb-4 shrink-0">
        ...
        {(fEstado || fProvId) && (
          <button onClick={() => { setFEstado(""); setFProvId(""); setFProvDisplay(""); setTimeout(() => { setPagina(1); cargar(1); }, 0); }}
      ...
      {/* Modal: preview del asiento del comprobante */}
      {preview && (
              ...
              <table className="w-full text-[13px]">
                ...
                <tbody>
                  {preview.lineas.map((l, i) => (
                    <tr key={i} className="border-b border-gray-50">
                      ...
                      <td className="px-3 py-2 text-gray-500">{l.tercero_nombre}</td>
                ...
                <tfoot>
                  <tr className="border-t-2 border-gray-300 font-bold text-gray-900 text-[14px]">
                    ...
                    <td className="px-3 py-2.5 text-right font-mono">{fmt(preview.total_debito)}</td>
                    <td className="px-3 py-2.5 text-right font-mono">{fmt(preview.total_credito)}</td>
                  </tr>
                </tfoot>
              </table>
