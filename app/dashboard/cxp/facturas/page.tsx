        ...
        <div className="flex-1 overflow-auto">
          <table className="w-full text-[12px]">
            <thead className="sticky top-0 bg-white z-10 border-b border-gray-100">
              <tr>
                {["Número", "Nº proveedor", "Fecha", "Vencimiento", "Proveedor", "Total", "Saldo", "Estado", ""].map((h) => (
                  <th key={h} className={`${["Total","Saldo"].includes(h) ? "text-right" : "text-left"} px-3 py-2.5 text-[10px] font-bold uppercase tracking-wide text-gray-400 whitespace-nowrap`}>{h}</th>
                ))}
              </tr>
            </thead>
